...
async def main(message: cl.Message):
    ...
    result, _, image_data = await handler.ahandle_prompt(user_input, str(user_id))
    image_dir = "/home/andrew/work/AcademicLLM/data/images"
    ...
    if response and "payload" in response:
        ...
        if value != "next":
            handler.assistant._save_flat_log(
                user_id,
                "rating",
                value,
                value
